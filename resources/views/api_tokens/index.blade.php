<x-system::table>
    ...
    <x-slot:button>
        <x-system::table.button data-table-id="ApiTokens" data-modal="{{ route('system.api-token.create') }}"
                                data-width="600px">
            添加
        </x-system::table.button>
        <x-system::table.button data-table-id="ApiTokens" data-action="{{ route('system.api-token.destroy') }}"
