<x-admin::form :action="request()->url()" table-id="UserTable">
    ...
    <x-admin::form.input type="password" name="current_password" pattern="^\S{1,}$" required vali-name="验证密码"
    ...
    <x-admin::form.input type="password" name="password" pattern="^(?![\d]+$)(?![a-zA-Z]+$)(?![^\da-zA-Z]+$).{8,32}$"
                          :required="true"
                          vali-name="登录密码"
